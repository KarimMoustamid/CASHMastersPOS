...
public class CurrencyConfigLagacy
{
    ...
    private static readonly Lazy<CurrencyConfigLagacy> _instance = new(() => new CurrencyConfigLagacy());
    public static CurrencyConfigLagacy Instance => _instance.Value; // accessing the .Value will execute the initialization logic
